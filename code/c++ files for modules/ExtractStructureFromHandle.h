...
This file contains basic functions for dealing with handles of superpositions. 
A superposition is represented as a directed labeled tree.
This tree could be represented by adjacency/incidence matrix and labels of its vertices
Each function produces such labels and one of two possible variants of the matrix
