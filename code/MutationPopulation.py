import code.modules.mutator as mutator
...
def mutate_population(population, mutations_number, number_of_variables):
    ...
    Outputs:
     population         - population extended with new superpositions produced by mutations
    """
    ...
    for i in range(mutations_number):
        ...
        new_generated_superpositions.append(mutator.mutation(model_to_mutate, number_of_variables))
