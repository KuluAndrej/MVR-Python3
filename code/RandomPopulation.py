import code.modules.random_model_generator as random_model_generator
...
def random_population(number_of_models, number_of_variables, required_size):
    ...
    list_of_new_handles = [random_model_generator.random_model_generation(number_of_variables, required_size) for i in range(number_of_models)]


    # convert new strings to a population and append it to the existed one
    random_population = StringToModel.strings_to_population(list_of_new_handles)
